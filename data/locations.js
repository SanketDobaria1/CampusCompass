...
const exportedMethods = {
    ...
    async create(name, desc, type, operating_hours){
        ...
        if (!insertInfo.acknowledged || !insertInfo.insertedId) { throw 'Could not add Location' }
    ...
    async update(id, name, desc, type, operating_hours){
        ...
        if (updatedInfo.lastErrorObject.n === 0) throw 'Could not update Location successfully !';

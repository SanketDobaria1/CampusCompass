...
async function main() {
  ...
  const McLean211 = await roomsData.create(mcLeanHall._id, 211, 40, 2, "admin");
  ...
  const Burchard514 = await roomsData.create(burchard._id, 514, 21, 5, "admin");
  ...
  const Edwin231 = await roomsData.create(edwin._id, 231, 19, 2, "admin");
  ...
  const Howe303 = await roomsData.create(howeCenter._id, 303, 59, 3, "admin");
  ...
  const Burchard111 = await roomsData.create(burchard._id, 111, 35, 1, "admin");
  ...
  const McLean323 = await roomsData.create(mcLeanHall._id, 323, 45, 3, "admin");
  ...
  const Edwin122 = await roomsData.create(edwin._id, 122, 39, 1, "admin");

(function ($) {
  ...
  function renderData(data) {
    ...
    data.forEach((department) => {
      ...
      if (isAdmin)
        renderEdit = `
        <button type="button" data-action="edit" class="submit-button" data-id="${department._id}">Edit</button>
        <button atype="button" data-action="delete"  class="submit-button" data-id="${department._id}">Delete</button>`;
      else renderEdit = "";

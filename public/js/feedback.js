function events() {
  ...
  if (staticForm) {
    ...
    let feedbackDescriptionField = document.getElementById(
    ...
    staticForm.addEventListener("submit", (event) => {
      ...
      try {
        ...
        if (eventTypeInput == "events") {
          ...
          let DepartmentListInput = checkId(
            DepartmentListField.value,
            "event id"
          );
          if (locationsListField.length > 0) {
            locationsListField.remove(locationsListField.length - 1);
          ...
          let locationsListInput = checkId(
            locationsListField.value,
            "event id"
          );
          if (DepartmentListField.length > 0) {
            DepartmentListField.remove(DepartmentListField.length - 1);
        ...
        feedbackDescriptionInput = checkString(
